...
public class Stat {
    ...
    public static void main(String[] args) {
        ...
        //标准差
        double[] vs2 = new double[]{0,0.1,0.1};
        StandardDeviation standardDeviation = new StandardDeviation();
        System.out.println("一组数据的标准差为：" + standardDeviation.evaluate(vs2));
        //variance--方差
        ...
        double[] vs = new double[]{0,0.1,0.4};
//        System.out.println("总体方差为：" + StatUtils.populationVariance(values));
        System.out.println("总体方差为：" + StatUtils.populationVariance(vs));
        //product--乘积
        ...
        System.out.println("一组数据的方差差异性为：" + StatUtils.varianceDifference(values, values2,
